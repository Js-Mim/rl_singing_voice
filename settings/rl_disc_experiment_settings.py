...
exp_settings = {
    # Experiment
    'exp_id': 'r-mcos-disc',                    # An id to store specific experiment results
    ...
    'embedings_only': False,                    # If the Discriminator's embedding layer used for reconstruction
    'embedding_space_dim': 800,                 # The dimensionality of the space of first layer of the discriminator
    'disc_lat_dim': 100,                        # The dimensionality of the latent space of the discriminator
